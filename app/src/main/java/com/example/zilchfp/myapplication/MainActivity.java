...
public class MainActivity extends FragmentActivity implements
    ...
    private Class fragmentArray[] = { OrdersMenu.class,RouteMenu.class, StatusMenu.class,
                                    MessageMenu.class, PersonalMenu.class};
    private int imageViewArray[] = { R.drawable.tab_home_btn, R.drawable.tab_view_btn,
                                     R.drawable.tab_view_btn, R.drawable.tab_view_btn, R.drawable.tab_view_btn };

    private String textViewArray[] = {"订单","路径规划","状态","消息","个人中心"};
